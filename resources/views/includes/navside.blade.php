<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://www.instagram.com/hikaks_4/ " target="_blank">
        <img src="{{asset('images/lorem.jpeg') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Akmal Syaiful</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('laporan-tanggal') }}">
            ...
            <span class="nav-link-text ms-1">Laporan pertanggal</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('laporan-pelanggan') }}">
            ...
            <span class="nav-link-text ms-1">Laporan perpelanggan</span>
          </a>
        </li>
        <li class="nav-item">
            <a class="nav-link  " href="{{ route('laporan-produk') }}">
              ...
              <span class="nav-link-text ms-1">Laporan perproduk</span>
            </a>
          </li>
      </ul>
    </div>
